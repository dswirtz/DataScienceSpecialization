...
##----------WhatIsMeanTotalNumberOfStepsTakenPerDay----------##
...
##----------WhatIsTheAverageDailyActivityPattern----------##
...
# calculate mean and median of total number of steps taken per day of
# adjusted dataset
...
##----------DifferencesInActivityPatternsBetweenWeekdaysAndWeekends----------##
